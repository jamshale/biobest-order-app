...
function populateCustomerPageInfo(){
    ...
    //Ship-To
    $("#ship_to_button").html(`<h4>${test_ship_to} </h4><span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>`)
    $("#ship_to_import").html(`<li><a href="#">${test_ship_to} </h4><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></a></li>`)
    //Invoice-To
    $("#invoice_to_button").html(`<h4>${test_ship_to} </h4><span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span>`)
